...
if __name__ == '__main__':
    # -------------------------------- get mask main.py --------------------------------------
    # YOLO 모델 로드
    yolo_model = YOLO("models/Oil_Tank_Shadow_Detect_Model_v11.pt")

    # 추론할 이미지가 있는 폴더 경로 지정
    image_folder = "static/uploads/"  # 원하는 이미지 폴더 경로로 수정

    # 결과 이미지를 저장할 폴더 경로 지정
    output_folder = "static/mask/"  # 원하는 결과 이미지 폴더 경로로 수정
...
#-------------------------------------------------------------------------------------------
    ...
    parser.add_argument('--input_dir', default='static/',
        type=str, help='Directory of validation images')
    parser.add_argument('--result_dir', default='static/output/',
